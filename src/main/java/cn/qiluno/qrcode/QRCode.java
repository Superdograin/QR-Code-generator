...
public class QRCode {
     ...
     * 21 and 177 (inclusive). This is equal to version &times 4 + 17. */
    ...
    public QRCode(int version, Ecc ecl, byte[] dataCodewords, int mask) {
        ...
        this.errorCorrectionLevel = Objects.requireNonNull(ecl);
    ...
    // endregion ---- Private helper methods for constructor: Drawing function modules
    ...
    // endregion ---- Private helper methods for constructor: Codewords and masking
}
